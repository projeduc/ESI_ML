...
\institute{ %
	\parbox{.3\textwidth}{Laboratoire de la Communication dans les Systèmes Informatiques (LCSI)}
	\hfill
	\parbox{.3\textwidth}{Laboratoire des Méthodes de Conception des Systèmes	(LMCS)}
	
	\vspace{6pt}
	École  nationale Supérieure d'Informatique (ESI, ex. INI), Alger, Algérie
}
\author[ \textbf{\footnotesize\insertframenumber/\inserttotalframenumber} \hspace*{1.5cm} ESI - ARIES \& BENATCHBA (2021-2022)] %
{ARIES Abdelkrime \hfill BENATCHBA Karima}
