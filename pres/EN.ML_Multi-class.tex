...
\begin{frame}
	...
	\begin{itemize}
		\item Number of available classes: 2
		\item Number of chosen classes: 1
		\item Examples
		\begin{itemize}
			\item Classify an image as containing an object or not.
			\item Finding out if a message is spam or not
		\end{itemize}
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item Number of available classes: L \textgreater\ 2
		\item Number of chosen classes: 1
		\item Examples
		\begin{itemize}
			\item Detect an animal from an input image.
			\item Detect a movie's certification (PG, R, etc.) from its description.
		\end{itemize}
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item Number of available classes: L \textgreater\ 2
		\item Number of chosen classes: K \textless= L
		\item Examples
		\begin{itemize}
			\item Detect many animals from an input image.
			\item Find the clothes (hat, jeans, scarf, etc.) from an image.
			\item Detect movie's genres (Sci-fi, Action, Comedy, etc.) from its description.
		\end{itemize}
	\end{itemize}
...
\begin{frame}
	\frametitle{Machine Learning}
	\framesubtitle{Multi-label logistic regression}
	
	\begin{itemize}
		\item Like multi-class classification
		\item The output is a vector of $L$ classes
		\item When trained, the vector can have many ones
	\end{itemize}
