...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \optword{Intégrées (embedded)} : les attributs sont sélectionnés pendant l'entrainement
		\item \optword{Enveloppante (Wrapper)} : on sélectionne les meilleurs attributs pour un estimateur donné avant d'entrainer
	\end{itemize}
