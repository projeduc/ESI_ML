...
\institute{ %
	\parbox{.6\textwidth}{\begin{center}
			Laboratoire de la Communication dans les Systèmes Informatiques (LCSI)\\
			\includegraphics[height=.8cm]{../extra/logo/lcsi-logo.png}
	\end{center}}
	\hskip0.5cm%\hfill
	\parbox{.35\textwidth}{\begin{center}
			Laboratoire des Méthodes de Conception des Systèmes	(LMCS)\\
			\includegraphics[height=1cm]{../extra/logo/lmcs-logo.png}
		\end{center}
	}
...
\author[ESI - ARIES \& HAMDAD \& BENATCHBA (2023-2024)] %
{Abdelkrime Aries  \hskip1cm Leila Hamdad \hskip2cm Karima Benatchba}
