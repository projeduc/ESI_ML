...
\cfoot{ESI/NLP/SIQ2-SIL2  (2022-2023)}
\rfoot{\textbf{\thepage}}
...
\begin{abstract}
	Machine learning (ML, en français : Apprentissage automatique) fait partie aux méthodes de l'intélligence artificielle.
	...
	Dans ces TPs, nous allons apprendre comment ces algorithmes fonctionnent en essayant d'implémenter des version simples.
	...
	La deuxième partie exploite des APIs existants afin de faire des tests sur les différents paramètres d'un algorithme.
	Dans cette partie, l'étudiant doit analyser les résultats du test (pourquoi nous avons eu ces résultats ?).
